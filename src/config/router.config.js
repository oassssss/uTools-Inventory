    ...
    children: [
      {
        ...
        redirect: '/customer/list',
        component: RouteView,
        meta: { title: '客户', keepAlive: true, icon: 'user' },
        children: [
          {
            path: '/customer/list',
            name: 'customerList',
            component: () => import('@/views/customer/List'),
            meta: { title: '客户列表', keepAlive: true, icon: 'table' }
          },
          {
            path: '/customer/bills',
            name: 'customerBills',
            component: () => import('@/views/customer/Bills'),
            meta: { title: '客户账单', keepAlive: true, icon: 'account-book' }
          }
        ]
      },
      {
        ...
        component: RouteView,
        meta: { title: '产品', keepAlive: true, icon: 'shop' },
        children: [
          {
            path: '/product/list',
            name: 'productList',
            component: () => import('@/views/product/List'),
            meta: { title: '产品列表', keepAlive: true, icon: 'table' }
          }
          // {
          //   path: '/customer/bills',
          //   name: '客户账单',
          //   component: () => import('@/views/customer/Bills'),
          //   meta: { title: '客户账单', keepAlive: true, icon: 'table' }
          // }
        ]
      }
      // // dashboard
